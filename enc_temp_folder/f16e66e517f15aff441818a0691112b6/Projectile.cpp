    ...
    OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
    ...
    {
        OtherComp->AddImpulseAtLocation(m_projectileMovement->Velocity * 100.0f, Hit.ImpactPoint);
    }
    ...
    {
        GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Blue, TEXT("Hit on client"));
    }*/
}